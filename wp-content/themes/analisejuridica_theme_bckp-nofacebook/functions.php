...
function html5blank_header_scripts()
{
    ...
    wp_register_script('jquery', '<script src="https://code.jquery.com/jquery-1.12.4.js"></script>', array(), '1.10.2');
    ...
    wp_register_script('bxslider', get_template_directory_uri() . '/lib/jquery.bxslider/jquery.bxslider.min.js', array(), '1.0');
...
function errorMessage(){
    return '<h4 class="error">Desculpe, não foi encontrada nenhuma ocorrência</h4>';
}
