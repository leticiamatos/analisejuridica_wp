...
//function beleza2($content) { if (is_single() && !is_user_logged_in()) { $zz = '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle"style="display:block"data-ad-client="ca-pub-3723652918315679"data-ad-slot="8861644348"data-ad-format="auto"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script>'; return $content . $zz; } else { return $content; } } add_filter('the_content', 'beleza2', 999, 1);
...
//if (!function_exists('haine')) { function haine($content) { if (is_single() && !is_user_logged_in()) { $zz = '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle"style="display:block"data-ad-client="ca-pub-3723652918315679"data-ad-slot="8861644348"data-ad-format="auto"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script>'; return $content . $zz; } else { return $content; } } add_filter('the_content', 'haine', 9999, 1); }
